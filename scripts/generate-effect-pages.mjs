...
const template = (effect) => `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <link rel="icon" type="image/png" href="../assets/brand/tradimation-symbol.png">
  <link rel="stylesheet" href="../site/site.css">
</head>
<body data-effect="${effect.id}">
  <header class="site-head"><nav><a class="brand mono" href="../index.html"><img class="brand-symbol" src="../assets/brand/tradimation-symbol.png" alt="" width="38" height="38">Tradimation</a><div class="nav-links mono"><a href="../index.html">Home</a><a class="current" href="../catalog.html">Effects</a><a href="https://github.com/tradimation/tradimation">GitHub ↗</a></div></nav></header>
  ...
  <script type="module" src="../site/detail.js"></script>
</body>
</html>
`;

const outputDirectory = new URL("../effects", import.meta.url);
await rm(outputDirectory, { recursive: true, force: true });
await mkdir(outputDirectory, { recursive: true });
await Promise.all(effectDocs.map((effect) => writeFile(new URL(`../effects/${effect.id}.html`, import.meta.url), template(effect))));
